...
def run(mode, solver_file):
    ...
    if mode == 'train':
        experiment = src.enet.experiments.core.SemanticSegmentationExperiment(**kwargs)
    elif mode == 'predict':
        experiment = src.enet.experiments.core.InferenceExperiment(**kwargs)
    elif mode == 'overfit':
        experiment = src.enet.experiments.core.OverfittingExperiment(**kwargs)
    elif mode == 'data':
        experiment = src.enet.experiments.core.DryDatasetExperiment(**kwargs)
    else:
