...
from enet import models
from enet.data import utils
from enet.data.pycocotools import mask as cocomask
from enet.predict import predict
...
if __name__ == '__main__':
    if K.backend() == 'tensorflow':
        ...
        ss = tf.Session(config=tf.ConfigProto(gpu_options=tf.GPUOptions(allow_growth=True)))
        K.set_session(ss)
